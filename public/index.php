<?php
    ...
    * )
    */
    $app->get("/Products/{sku}", function (Request $request, Response $response, $args) {
        validate_token();
    ...
    */
    $app->post("/Product", function (Request $request, Response $response, $args) {
               ...
               if (!$id_category) {
                ...
                if (!$name) {
                    error_function(400, "name is invalid, must contain at least 5 characters");
                }
                if (!$image) {
                    error_function(400, "image is invalid, must contain at least 5 characters");
                }
                if (!$description) {
                    error_function(400, "description is invalid, must contain at least 5 characters");
                }
                if (!$price) {
